...
- **IGSC Harmonized Screening Protocol v3.0** — screens synthetic orders against pandemic pathogen sequence databases using a 100 bp matching threshold for long sequences; 1918 HA consensus sequences would likely trigger screening if submitted for synthesis; the October 2026 expansion to 50 bp oligonucleotide screening will further reduce the synthesis-ordering pathway for pandemic pathogen sequences
